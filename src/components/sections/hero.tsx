        ...
        <div className="row align-items-center">
          <div className="col-lg-12 col-sm-12">
            ...
            <SlideUp className="hero-content rmb-25 text-center">
              <h2>Hi! 👋 I'm a Creative Professional</h2>
              <h1>UX designer and <span>Web</span> Developer</h1>
            ...
            <SlideUp delay={2}>
              <div ref={ref} className="hero-counter-area d-flex justify-content-around wow fadeInUp delay-0-4s">
                <div className="counter-item counter-text-wrap">
                  <span className="count-text plus">{inView && <CountUp end={8} />}</span>
                  <span className="counter-title">Years Of Experience</span>
                </div>
                <div className="counter-item counter-text-wrap">
                  <span className="count-text k-plus">{inView && <CountUp end={1} />}</span>
